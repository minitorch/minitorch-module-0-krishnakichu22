...
def test_sigmoid(a: float) -> None:
    ...
    * It is  strictly increasing.
    """
    # Checking the Sigmoid function is always between 0.0 and 1.0
    assert 0.0 <= sigmoid(a) <= 1.0

    # Checking if 1 - sigmoid is same as sigmoid of ng
    assert_close(1-sigmoid(a),sigmoid(-a))

    # Checking whether is crosses 0 at 0.5
    assert sigmoid(0.5) > 0.0

    # Checking whether it strictly increasing 
    if a < 0:
...
def test_transitive(a: float, b: float, c: float) -> None:
    ...
    # Checking the transitive property of a < b and b < c == a < c
...
def test_other(a:float,b:float,c:float) -> None:
    ...
    """
    # Since this Asked for some other propery I will try out the Associate Property
    # Math : (a+b)+c = a+(b+c)
